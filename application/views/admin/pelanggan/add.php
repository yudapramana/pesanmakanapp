...
<div class="container-fluid">
  ...
  <p class="mb-4"><marquee style="color: red;"><b><i>SELAMAT DATANG DI APLIKASI PEMESANAN MAKANAN INI. HARI INI TANGGAL <?= tgl_indo(date('Y-m-d')) ?> DAN HARI <?= $days[date('w')] ?></i></b></marquee></p>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form class="form-horizontal form-label-left" action="<?= base_url('pelanggan/proses_tambah') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9 col-sm-9 ">
                <textarea type="text" class="form-control" name="alamat" placeholder="ALAMAT" rows="5"></textarea>
              </div>
            </div>
            <div class="form-group row">
              <label class="control-label col-md-3 col-sm-3">NOMOR HANDPHONE</label>
              <div class="col-md-3 col-sm-3">
                  <input type="number" class="form-control" name="nohp" placeholder="0812xxxxxx">
              </div>
            </div>
