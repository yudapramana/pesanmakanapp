...
<head>
    ...
    <title>APLIKASI PEMESANAN MAKANAN - Login</title>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <div class="centered-content">
                                    <img src="<?= base_url('assets/images/logo-bg.png') ?>" alt="Logo">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url('Login/aksilogin') ?>" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block"><i class="fa fa-sign-in-alt"></i> Login</button>
                                        <hr>
                                    </form>
                                    <hr>
                                    <div class="text-center">
