...
<div class="container-fluid">
  ...
  <p class="mb-4"><marquee style="color: red;"><b><i>SELAMAT DATANG DI APLIKASI PEMESANAN MAKANAN INI. HARI INI TANGGAL <?= tgl_indo(date('Y-m-d')) ?> DAN HARI <?= $days[date('w')] ?></i></b></marquee></p>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form class="form-horizontal form-label-left" action="<?= base_url('Transaksi/proses_edit_diskon') ?>" method="POST" enctype="multipart/form-data">
            <div class="form-group row">
              <label class="control-label col-md-3 col-sm-3 text-center">DISKON</label>
              <div class="col-md-2 col-sm-2 input-container">
                <input type="hidden" class="form-control" name="id" value="<?= $diskon['id_diskon'] ?>">
                <input type="number" class="form-control" name="diskon" placeholder="DISKON MAKANAN" value="<?= $diskon['diskon'] ?>">
                <span>%</span>
              </div>
            </div>
